/**
 * MedicationActions atom component
 * VitalGo brand-compliant action buttons for medication operations
 */
'use client';
...
export const MedicationActions: React.FC<MedicationActionsProps> = ({
  ...
  const handleToggleActive = () => {
    if (onToggleActive && !isLoading) {
      onToggleActive(medication.id, !medication.isActive);
    }
  };
  ...
  const toggleButtonClasses = `
    ${baseButtonClasses}
    ${medication.isActive
      ? 'text-vitalgo-dark bg-vitalgo-green-lightest border border-vitalgo-green-lighter hover:bg-vitalgo-green-lighter focus:ring-vitalgo-green'
      : 'text-vitalgo-green bg-white border border-vitalgo-green hover:bg-vitalgo-green-lightest focus:ring-vitalgo-green'
    }
  `;
    ...
    return (
      <div className={`relative ${className}`} data-testid={testId}>
        <button
          ...
          aria-label="Opciones del medicamento"
        ...
        <div className={`flex items-center space-x-1 ${className}`} data-testid={testId}>
          ...
          {onToggleActive && showToggle && (
            <button
              ...
              disabled={isLoading}
              className={`p-1.5 rounded-md transition-colors duration-150 focus:outline-none focus:ring-2 focus:ring-offset-1 disabled:opacity-50 ${
                medication.isActive
